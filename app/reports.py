...
def build_pdf_report(user, logs, journals, checklist_stats, goals):
    ...
    doc    = SimpleDocTemplate(
        ...
        title=f"BloomCare Health Report – {user.full_name}",
    )
    ...
    # ── Cover header ─────────────────────────────────────────
    cover_data = [[
        Paragraph('🌸 BloomCare AI', ParagraphStyle(
    ...
    story.append(Paragraph(
        '<b>Medical Disclaimer:</b> This report is generated by BloomCare AI for '
...
def my_report():
    ...
    filename   = f"BloomCare_report_{user.username}_{today}.pdf"
