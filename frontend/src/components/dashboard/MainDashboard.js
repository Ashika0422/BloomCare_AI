...
const s = {
  ...
  numInput: (focused) => ({ width: '100%', padding: '10px 14px', borderRadius: 10, border: `1.5px solid ${focused ? 'var(--primary)' : 'var(--border)'}`, background: focused ? 'var(--blush)' : 'var(--cream)', fontSize: 15, color: 'var(--slate)', outline: 'none', fontFamily: 'var(--font-body)', transition: 'all 0.2s', boxShadow: focused ? '0 0 0 3px rgba(237,18,164,0.15)' : 'none' }),
  saveBtn: { marginTop: 16, padding: '10px 22px', borderRadius: 99, background: 'linear-gradient(135deg, var(--primary), var(--primary-dark))', color: '#fff', border: 'none', cursor: 'pointer', fontSize: 13, fontWeight: 600, letterSpacing: '0.03em', transition: 'all 0.2s', fontFamily: 'var(--font-body)', boxShadow: '0 3px 14px rgba(237,18,164,0.3)', display: 'flex', alignItems: 'center', gap: 6 },
